...
Item.create(name: 'Cherry', image: 'https://i.ibb.co/L9rdCpX/Cherry.png', kind: 'food')
...
Item.create(name: 'Apple', image: 'https://i.ibb.co/fpPJTrh/Apple.png', kind: 'food')
...
Item.create(name: 'Rope Toy', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSoEeK-hNuRFJX-MgJol2-RivavwAZ3z8PVRw&usqp=CAU', kind: 'toy')
